...
<div class="container">
    ...
    <form action="LoginServlet" class="form-signin"  method="POST">
        ...
        <h2 class="form-signin-heading">Login to your Digital Document Signing Account (2nd change) </h2>
        <h2 class="form-signin-heading">Login to your Digital Document Signing Account (3rd change) </h2>
